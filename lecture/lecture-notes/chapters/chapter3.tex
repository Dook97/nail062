...
Lze šachovnici s dvěma chybějícími protilehlými rohy perfektně pokrýt kostkami domina?
\end{example}
...
\begin{exercise}
Ukažte, že pro každý výrok $\varphi$ v CNF existuje \emph{ekvisplnitelný} výrok $\varphi'$ v 3-CNF (tj. $\varphi$ je splnitelný, právě když $\varphi'$ je splnitelný), který lze zkonstruovat v lineárním čase.
\end{exercise}
